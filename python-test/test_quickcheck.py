...
def test_proof(isa_repl):
    ...
    # isa_repl._initializeRepl("/home/hbd/projects/seL4-prover/datasets/examples/newcode2inv_divide/test1_post.thy", "/home/hbd/verification/l4v" , "AutoCorres", ["/home/hbd/verification/l4v"])
...
# (prove) hbd@amax:~/projects/Isa-Repl$ python ./python-test/test_quickcheck.py 
